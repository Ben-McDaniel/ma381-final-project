public class TypeE extends plant{
    double leaf_size;
    double height;
    ...
    public TypeE(double leaf_size, double height, double reproduction_rate, double disease_sus, int lifetime, int offspring) {
    ...
    public TypeE(TypeE parent1, TypeE parent2){
