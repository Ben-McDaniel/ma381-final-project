public class TypeD extends plant{
    double leaf_size;
    double height;
    ...
    public TypeD(double leaf_size, double height, double reproduction_rate, double disease_sus, int lifetime, int offspring) {
    ...
    public TypeD(TypeD parent1, TypeD parent2){
